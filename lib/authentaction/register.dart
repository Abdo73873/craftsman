...
class RegisterState extends State<Register> {
              ...
              child: Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    const Center(child: Text("Welcome to our application !",
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabled: true,
                          prefixIcon: Icon(
                            Icons.person, color: Colors.cyan.shade800,),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabled: true,
                          prefixIcon: Icon(
                            Icons.email, color: Colors.cyan.shade800,),
                      ...
                      validator: (value) {
                        ...
                        if (!RegExp(
                            "^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+.[a-z]").hasMatch(
                            value)) {
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabled: true,
                          prefixIcon: Icon(
                            Icons.ad_units_sharp, color: Colors.cyan.shade800,),
                          enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
                              borderSide: BorderSide(
                                color: Colors.cyan.shade700, width: 2,)),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabled: true,
                          prefixIcon: Icon(
                              Icons.home, color: Colors.cyan.shade800),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabled: true,
                          prefixIcon: Icon(
                            Icons.phone, color: Colors.cyan.shade800,),
                          enabledBorder: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(30),
                              borderSide: BorderSide(
                                color: Colors.cyan.shade700, width: 2,)),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabled: true,
                          prefixIcon: Icon(
                            Icons.key, color: Colors.cyan.shade800,),
                    ...
                    Row(
                      ...
                      children: [
                        const Text(
                          "Choose : ", style: TextStyle(fontSize: 20,
  ...
  void signUp(String email, String password, String rool)  {
  ...
  Future postDetailsToFirestore(String email, String role) async {
    ...
    if (role == 'user') {
      ...
      ref.doc(myId).set(myModel!.toMaP()).then((value){
